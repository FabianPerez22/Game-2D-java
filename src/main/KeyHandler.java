...
public class KeyHandler implements KeyListener {
    ...
    public void keyPressed(KeyEvent e) {
        ...
        // TRADE STATE
        else if(gp.gameState == gp.tradeState){ trade_State(code); }
        // CRAFTING STATE
        else if(gp.gameState == gp.craftingState){ craft_State(code); }
        // OVEN STATE
        ...
        if(gp.ui.titleScreenState == 0 ) {
            ...
            if(code == KeyEvent.VK_W){
                ...
                if(gp.ui.commandNum == 0) {
                    ...
                    // Add later new character
                    System.out.println("This one will be adde later");
                    gp.gameState = gp.playState;
                    gp.playMusic(0);
                }if(gp.ui.commandNum == 2) {
                    // Add later new character
    ...
    public void trade_State(int code) {
        if (code == KeyEvent.VK_ENTER){
            enterPressed = true;
        }
        if (gp.ui.subState == 0) {
    ...
    public void craft_State(int code) {
        if (code == KeyEvent.VK_ENTER){
            enterPressed = true;
        }
        if (gp.ui.subState == 0) {
