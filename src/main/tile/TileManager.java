...
public class TileManager {
    ...
    public TileManager(GamePanel gp) {
        ...
        // READ TILE DATA FILE
        InputStream is = getClass().getResourceAsStream("/res/maps/tiledatasv3.txt");
        ...
        // INITIALISE THE TILE ARRAY BASED ON THE fileNames size
        tile = new Tile[fileNames.size()];
        getTileImage();

        // GET THE maxWorldCol and row
        is = getClass().getResourceAsStream("/res/maps/customMapV1.txt");
        ...
        loadMap("/res/maps/newMerchantMap.txt", 1);
